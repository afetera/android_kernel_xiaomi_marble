...
OUTPUT_DIR=${HOME}/Bouquet_marble_out
KERNELSU_REPO=${HOME}/KernelSU
SUSFS_REPO=${HOME}/susfs4ksu
...
echo -e "${gre}Building kernel with Slim LLVM 23.1.0-rc2 $white"
CLANG_PATH=~/build_toolchain/llvm-23.1.0-rc2-x86_64/bin
